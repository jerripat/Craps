...
def getPlace():
  ...
  place = [onFour,onFive ,onSix, onEight, onNine, onTen]
...
chkOne = Checkbutton(
    root, text="4", variable=onFour, onvalue=1, offvalue=0, relief=SUNKEN
)
...
chkTwo = Checkbutton(
    root, text="5", variable=onFive, onvalue=1, offvalue=0, relief=SUNKEN
)
...
chkThree = Checkbutton(
    root, text="6", variable=onSix, onvalue=1, offvalue=0, relief=SUNKEN
)
...
chkFour = Checkbutton(
    root, text="8", variable=onEight, onvalue=1, offvalue=0, relief=SUNKEN
)
...
chkFive = Checkbutton(
    root, text="9", variable=onNine, onvalue=1, offvalue=0, relief=SUNKEN
)
...
chkSix = Checkbutton(
    root, text="10", variable=onTen, onvalue=1, offvalue=0, relief=SUNKEN
)
